// Rawaq icon set — consistent 24-viewBox stroke icons (2px, round caps).
// Sized in em by default so icons track the surrounding font size.
const PATHS = {
  share: (
    <>
  ...
  leaf: (
    <>
      <path d="M6 20c0-8 4-13 13-14-1 9-6 13-13 14Z" />
      <path d="M6 20c3-5 6-8 10-10" />
    </>
  ),
  home: (
    <>
...
export default function Icon({ name, size = "1.25em", strokeWidth = 2, style }) {
  ...
  return (
    <svg
      ...
      aria-hidden="true"
      style={{ flexShrink: 0, verticalAlign: "-0.22em", ...style }}
    >
      {path}
    </svg>
  );
